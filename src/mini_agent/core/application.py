...
class AgentApplication:
    ...
    async def list_sessions(self, *, include_archived: bool = True) -> list[Session]:
        return await self._sessions.list(include_archived=include_archived)
    ...
    async def run_turn(self, session_id: str, prompt: str) -> AsyncIterator[AgentEvent]:
        ...
        await self._sessions.append_message(session_id, user_message)
